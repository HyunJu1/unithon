...
public class BluetoothManager {
    ...
    public synchronized void start() {
        ...
        // Start the thread to listen on.png a BluetoothServerSocket
     ...
     *
     * @param socket The BluetoothSocket on.png which the connection was made
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    // This is a blocking call and will only return on.png a
